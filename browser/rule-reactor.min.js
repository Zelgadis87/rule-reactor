...
n.map(function(n){a[r]=a[r]?a[r]:Array(e.length),a[r][0]=o,a[r][t]=n,r++})}}),n&&(a=a.filter(function(e,t){return n(e,t)})),t&&a.map(function(e,n){a[n]=t(e,n)}),r.splice.apply(r,[0,0].concat(a))}),r)}function n(e){Object.keys(e.domain).forEach(function(n){var t=e.domain[n]
...
if(r.forEach(function(e){n instanceof t.domain[e]&&t.bindings[e].push(n),i.push(t.bindings[e])}),r.every(function(e){return t.bindings[e]&&t.bindings[e].length>0})){var o=e(i,function(e){return e.indexOf(n)>=0},function(e){return e.forEach(function(n,i){var o=r[i],a=t.crossProducts.get(o)
a||(a=[],t.crossProducts.set(o,a)),a.push(e)}),e})
o&&t.test(n)}},r.prototype.unbind=function(e){var n=this,t=Object.keys(n.bindings)
...
r.splice(i,1),o&&o["delete"]()}}})},r.prototype.test=function(e,n){var r=this,o=new Map,a=Object.keys(r.bindings)
e&&n&&!a.some(function(t){return e instanceof r.domain[t]&&r.range[t][n]})||(e?a.forEach(function(t){if(e instanceof r.domain[t]&&(!n||r.range[t][n])){var i=r.crossProducts.get(t)
if(i){var a=[]
i.forEach(function(n){if(n.indexOf(e)>=0){a.push(n)
var t=r.activations.get(n)
t&&t["delete"]()}}),o.set(t,a)}}}):r.crossProducts.forEach(function(e,n){o.set(n,e),e.forEach(function(e){var n=r.activations.get(e)
n&&n["delete"]()})}),o.forEach(function(e){e.forEach(function(e){if(r.condition.apply(r,e)){var n=new t(r,e)
