...
if(!f)return[]
i|=l
do{var d=s[p],g=u.get(d)
void 0===g?(o++,g=a.length,u.set(d,g),c[g]=d?d.valueOf():d):a[g]|=l}while(++p<f)}while(++r<t)
var v=[],p=0
do a[p]===i&&(v[v.length]=c[p])
while(++p<o)
return v}function n(e){this.collections=e?e:[],Object.defineProperty(this,"length",{set:function(){},get:function(){var e=1
...
return e.forEach(function(e){n.collections.push(e)}),n},n.prototype.push=function(e,n){return this.collections[e].push(n),this},n.prototype.get=function(e,n){for(var r,i=this,o=[],c=1,a=[],u=1,s=i.collections.length;s--;u*=r)a[s]=[u,r=i.collections[s].length],c*=i.collections[s].length
return e>=c?void 0:(t(e,i.collections,a,o),!n||n.every(function(e,n){return void 0===e||("function"==typeof e?e.call(o,o[n],n):!1)||o[n]===e})?o.slice(0):void 0)},n.prototype.indexOf=function(e){for(var n,t=this,r=0,i=[],o=1,c=t.collections.length;c--;o*=n)i[c]=o,n=t.collections[c].length
return t.collections.every(function(n,t){var o=n.indexOf(e[t])
return o>=0?(r+=o*i[t],!0):!1})?r:-1},n.prototype.intersection=function(t){var r=this,i=[]
return r.collections.length!==t.collections.length?new n([]):(r.collections.forEach(function(n,r){i.push(e(n,t.collections[r]))}),new n(i))},n.prototype.verify=function(e,n){var t=this,r=t.get(e)
return r&&r.every(function(e,t){return e===n[t]})},n.prototype.forEach1=function(e,n,t){for(var i=this,o=[],c=[],a={count:0},u=i.collections.length;u--;)c[u]=i.collections[u].length
r(0,a,i.collections,c,o,e,n,t)},n.prototype.forEach=n.prototype.forEach1
var s={}
