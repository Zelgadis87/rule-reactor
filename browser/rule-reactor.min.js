...
var s=[]
return o.some(function(i){return(!r||n.range[i][r])&&(i===e?s.push([t.__rrid__]):s.push(f.bindings[i])),s.length===n.length}),s.length<n.length?u?(u=n.crossproducts.filter(function(e){return f.signatures[e]}),u.length>0):!1:(u=g(s,function(e){if(-1==e.indexOf(t.__rrid__))return!1
for(var r=[],i=0;i<l.length;i++)r.push(-1)
for(var i=0;i<e.length;i++)r[l.indexOf(o[i])]=e[i]
var s=e.map(a.get)
return e.indexOf(t.__rrid__)>=0&&n.apply(f,s)&&(!u||u.some(function(e){return e.every(function(e,n){return-1===e||r[n]===e})}))?(a.tracelevel>2&&c.log("Join: ",f,i,e.length,s),e.fullrow=r,r.row=s,!0):void 0},function(e){var n=e.fullrow
return e.fullrow=null,n}),u.length>0?(n.crossproducts=u,!0):!1)})&&u){for(var n=0;n<u.length;n++){var o=u[n].row
u[n].row=null
var s=new i(f,o)
a.agenda.push(s),f.activations.set(o,s)}p=!0}}),o?void o(null,p):!1},o.prototype.reset=function(e,n,t){var r,i=this,o=Object.keys(i.bindings)
