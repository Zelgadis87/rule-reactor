...
r.forEach(function(e){t instanceof n.domain[e]&&n.bindings[e].push(t),i.push(n.bindings[e])})
e(i,function(e){return e.indexOf(t)>=0},function(e){return e.forEach(function(t,i){var o=r[i],a=n.crossProducts.get(o)
...
r&&r["delete"]()}}),a.set(r,o)}}}):n.crossProducts.forEach(function(e,t){a.set(t,e),e.forEach(function(e){o=n.activations.get(e),o&&o.forEach(function(e){e["delete"]()})})}),a.forEach(function(e,t){e.forEach(function(e){if(n.condition.apply(n,e)){var t=new r(n,e)
